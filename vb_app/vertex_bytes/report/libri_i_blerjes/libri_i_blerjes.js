console.log("➡️ STARTING: Libri i Blerjes JS File Loaded");

frappe.query_reports["Libri i Blerjes"] = {
	"filters": [
		{
			"fieldname": "company",
			"label": __("Company"),
			...
			"reqd": 1,
			"read_only": 0 // Changed to 0 so user can select other allowed companies
		},
		{
